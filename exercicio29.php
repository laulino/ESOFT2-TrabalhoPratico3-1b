...
Descritivo:Escreva um programa que leia um número real e, se for positivo,
exiba seu inverso (1/x); caso contrário, exiba o seu valor absoluto
...
if ($numero > 0) {
    $inverso = 1 / $numero;
    echo "O número é positivo. O seu inverso é: " . $inverso . "\n";
} else {

    $valor_absoluto = abs($numero); 
    echo "O número não é positivo. O seu valor absoluto é: " . $valor_absoluto . "\n";
}

// Verifica se o número é positivo para calcular o inverso ou o valor absoluto.
