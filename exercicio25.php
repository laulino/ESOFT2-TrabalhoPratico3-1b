...
*******************************************************************************/
$valor = (int)readline("Digite a temperatura em Fahrenheit: ");

$celsius= 5/9*($valor-32);

echo"A temperatura em Celsius é: $celsius" ."º Celsius"

/*
O programa lê o valor digitado em Fahrenheit e converte para Celsius,
depois ele mostra a temperatura.
*/
