...
Descritivo: Escreva um programa que declare uma variável inteira, atribua a ela o valor 10 e exiba o 
seu valor na tela com a mensagem formatada: 'Valor de x = [valor]'.
*******************************************************************************/
$valor = (int) 10;

echo("Valor de x = $valor");


/*
Eu atribuo à variavel $valor o tipo int e em seguida o valor 10.
No final dou um echo com o valor da variavel.
*/
?>