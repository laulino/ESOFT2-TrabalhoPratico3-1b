...
if($valor>0){ 
    $valor*=2;
    $mensagem="O dobro do seu valor digitado é: $valor.";
}else{
    $mensagem="ERRO, Por favor inclua um valor positivo.";
}

echo($mensagem);

/*
O programa lê o valor digitado e mostra o dobro,
caso o valor seja menor ou igual a zero, mostra a mensagem de erro.
*/
